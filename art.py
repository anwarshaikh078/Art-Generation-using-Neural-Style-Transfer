# -*- coding: utf-8 -*-
"""
Created on Sun Jan 13 17:55:27 2019
...
#gram matrix for computation of style cost
def gram_matrix(A):
    """
    Argument:
...
def compute_style_cost(model, STYLE_LAYERS):
    ...
    return tf.cast(J_style,tf.float32)
...
content_image = imread("images\content2.jpg")
content_image = reshape_and_normalize_image(content_image)

style_image = imread("images\style2.jpeg")
...
def model_nn(sess, input_image, num_iterations = 200):
    ...
    for i in range(num_iterations):
        ...
        if i%20 == 0:
            ...
            save_image("output1/=" + str(i) + ".png", generated_image)
    
    # save last generated image
    save_image('output1/generated_image.png', generated_image)
